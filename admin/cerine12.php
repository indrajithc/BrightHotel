      ...
      <section class="wrapper site-min-height">
        ...
        <div class="row mt">
         <div class="form-group ">
                    ...
                    <label for="designation" class="control-label col-lg-2">Employee id</label>
                    <div class="col-lg-10">
                      ...
                      <table>
                        ...
                        if( isset( $_POST['designation'] ) ) {
                          ...
                          // echo "$designation";
                              ...
                              $query1="SELECT * FROM employee where empid='$designation'";
...
?>
 ...
 <div class="row mt">
        ...
        <!-- /row -->
                    					<label for="salary" class="control-label col-lg-2">name</label>
                    							<div class="col-lg-10">
                      <input class=" form-control" id="salary" name="salary" type="text" value="<?php echo $row2[6]; ?>"/>
                    </div>
						</div>
                        </div>  
						                 <?php   } 
